...
// Rotas protegidas
router.post('/create-super-admin', auth_1.authMiddleware, authController.AuthController.createSuperAdmin);
router.post('/logout', auth_1.authMiddleware, authController.AuthController.logout);
